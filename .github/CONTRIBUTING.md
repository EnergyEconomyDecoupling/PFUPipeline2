...
# Contributing to `PFUPipeline2`

This document outlines how to propose a change to the `PFUPipeline2` package.
...
* New code should be written in a style that matches the rest of the code in `PFUPipeline2`. 
