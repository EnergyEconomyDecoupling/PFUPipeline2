...
#'                              Default is `PFUPipelineTools::aggregation_file_tabs`.
#' @param many_colname The name for the many column in the aggregation tables.
#'                     Default is `PFUPipelineTools::aggregation_file_info$many_colname`.
#' @param few_colname The name for the few column in the aggregation tables.
#'                    Default is `PFUPipelineTools::aggregation_file_info$few_colname`.
#'
...
load_aggregation_maps <- function(path,
                                  aggregation_file_tabs = PFUPipelineTools::aggregation_file_tab_names,
                                  many_colname = PFUPipelineTools::aggregation_file_cols$many_colname,
                                  few_colname = PFUPipelineTools::aggregation_file_cols$few_colname) {
